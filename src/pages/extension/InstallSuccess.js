...
import { storeDeviceInformations } from "../../services/authentication/AuthServices";
...
function InstallSuccess() {
  ...
  return (
    <>
      <div className={styles["main-success"]}>
        <header className={styles.header}>
          <Link to={{ pathname: "https://friender.io/" }} target="_blank">
            <img src={LogoL} alt="Logo" loading="lazy" />
          </Link>
          {!logState ? (
        ...
        <section className={styles["content-success"]}>
          ...
          <div className={styles["land-content"]}>
            ...
            <p>
              ...
              Friender extension in your browser.
            </p>
          </div>
        </section>
      </div>
