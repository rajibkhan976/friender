	...
	return (
		<div
			className={`modal-background editor-modal-background ${
				type === "CAMPAIGNS_MODAL_MESSAGE" ? "campaign-editor-modal-bg" : ""
			} ${type === "CAMPAIGNS_MESSAGE" ? "campaign-editor-quickMsg-bg" : ""}`}
		...
		>
			<div
				className={`modal editor-modal ${isExtanded && "expanded-modal"} ${
					type === "CAMPAIGNS_MODAL_MESSAGE" ? "campaign-editor-modal" : ""
				}`}
			>
				<div className='modal-content-wraper'>
					...
					<div className={`modal-header editor-modal-header`}>
						<span
							className='editor-modal-header-text'
							style={{ color: "#fff" }}
						>
							{"Quick message"}
						</span>
											...
											<div className='legend-tooltip'>
												...
												<div className='lengend-text-details'>
													...
													<span className='legend-text'>
														...
														curly brace '&#123;' and then list out the alternate
														variations that you want to use, separated by a pipe
														symbol '|'.
													</span>
											...
											<div className='legend-tooltip'>
												...
												<div className='lengend-text-details'>
													...
													<span className='legend-text'>
														...
														beginning of the field you want to insert from the
														list, followed by the corresponding field name.
													</span>
													<span className='legend-footer'>
					...
					<div className='modal-content editor-modal-content'>
						...
						<TextEditor
							...
							isEditorModalOpen={open}
						/>
					</div>
				</div>

				<div
					className='modal-expanding-icon'
					onClick={() => setExtanded(!isExtanded)}
				>
					<ModalExpandIcon />
				</div>
			</div>
